...
console.log(`  Google: ${hasGoogleConfig ? '✅' : '❌'}`);
console.log(`  Facebook: ${hasFacebookConfig ? '✅' : '❌'}`);
console.log(`  Apple: ${hasAppleConfig ? '✅' : '❌'}`);
...
if (hasGoogleConfig) {
  ...
  console.log('⚠️  Google OAuth désactivé - Variables d\'environnement manquantes');
}
...
if (hasFacebookConfig) {
  ...
  console.log('⚠️  Facebook OAuth désactivé - Variables d\'environnement manquantes');
}
...
if (hasAppleConfig) {
  ...
  console.log('⚠️  Apple OAuth désactivé - Variables d\'environnement manquantes');
}
